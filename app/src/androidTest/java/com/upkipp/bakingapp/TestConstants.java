...
class TestConstants {
    ...
    static Recipe getTestRecipe() {
        List<Recipe> testRecipeList = RecipeParser.parseRecipes(TEST_RECIPE_STRING);
    ...
    static List<Step> getTestSteps() {
        ...
        String[] step3 = InstrumentationRegistry.getTargetContext().getResources().getStringArray(R.array.steps_3);
        String[] step4 = InstrumentationRegistry.getTargetContext().getResources().getStringArray(R.array.steps_4);
        String[] step5 = InstrumentationRegistry.getTargetContext().getResources().getStringArray(R.array.steps_5);
        String[] step6 = InstrumentationRegistry.getTargetContext().getResources().getStringArray(R.array.steps_6);

        List<String[]> stepArrayList = new ArrayList<>();
        stepArrayList.add(step0); stepArrayList.add(step1); stepArrayList.add(step2);
