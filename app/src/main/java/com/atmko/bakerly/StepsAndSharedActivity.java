...
import com.atmko.bakerly.fragments.DescriptionFragment;
import com.atmko.bakerly.fragments.StepsFragment;
import com.atmko.bakerly.fragments.ThumbnailFragment;
import com.atmko.bakerly.models.Recipe;
import com.atmko.bakerly.models.Step;
import com.atmko.bakerly.R;
import com.atmko.bakerly.fragments.VideoPlayerFragment;
...
public class StepsAndSharedActivity extends AppCompatActivity
    ...
    private void loadDescriptionFragment(String description) {
        ...
        replaceFragment(R.id.description_container, descriptionFragment, DetailsActivity.DESCRIPTION_FRAGMENT_TAG);
    ...
    private void loadThumbnailFragment(String thumbnailUrl) {
        ...
        replaceFragment(R.id.thumbnail_container, thumbnailFragment, DetailsActivity.THUMBNAIL_FRAGMENT_TAG);
    }
    ...
    private void loadVideoFragment(String videoUrl) {
        ...
        replaceFragment(R.id.video_container, videoFragment, DetailsActivity.VIDEO_FRAGMENT_TAG);
    }
    ...
    private void setFragmentValues() {
        ...
        VideoPlayerFragment videoPlayerFragment = (VideoPlayerFragment) fragmentManager.findFragmentByTag(DetailsActivity.VIDEO_FRAGMENT_TAG);

        if (hasDescription) {
            showView(R.id.description_container);
            DescriptionFragment descriptionFragment = (DescriptionFragment) fragmentManager.findFragmentByTag(DetailsActivity.DESCRIPTION_FRAGMENT_TAG);
        ...
        if (hasThumbnail) {
            showView(R.id.thumbnail_container);
            ThumbnailFragment thumbnailFragment = (ThumbnailFragment) fragmentManager.findFragmentByTag(DetailsActivity.THUMBNAIL_FRAGMENT_TAG);
